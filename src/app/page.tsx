      ...
      <div className="mx-auto flex w-full max-w-6xl gap-10 px-6 py-10 lg:gap-16">
        ...
        <div className="w-full max-w-[900px]">
          ...
          <section id="what-i-do" className="scroll-mt-24 py-12">
            <h2 className="text-2xl font-semibold text-slate-950">What I do</h2>
            <p className="mt-4 text-base leading-7 text-slate-600">
          ...
          <section id="background" className="scroll-mt-24 py-12">
            <h2 className="text-2xl font-semibold text-slate-950">Background</h2>
          ...
          <section id="contact" className="scroll-mt-24 py-12">
            ...
            <div className="mt-6 flex flex-wrap gap-6 text-sm font-medium text-slate-700">
              <a
                className="rounded-full border border-slate-200 px-4 py-2 transition hover:border-slate-300 hover:text-slate-950 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400"
